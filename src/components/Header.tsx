...
function Header() {
  return (
    <div>
      <div className=' py-[48px] px-[103px] bg-white flex justify-between' >
        <div className=' flex items-center justify-between' >
            <div className=' mr-[50px]' >
                <Image width={102} height={42} alt={'ufami'} src={"/images/U’FAMI.png"} />
            </div>
            <div className=' flex items-center ' >
                <div className=' w-[520px] h-[50px] rounded-[80px] px-[10px] py-[9px] border-[1px] border-[#C7C7C7] flex items-center mr-[8px]'>
                   <span className='w-[28px] h-[28px] block mr-[8px]'>
                   ...
                   <span className='block text-[#C7C7C7] text-label-xl font-medium' > Rechercher </span>
                </div>
        ...
        <div className='flex items-center'>
            <div className='flex flex-col items-center ml-[50px]' >
                ...
                <span className=' text-label-lg font-semibold block mt-[3px] ' >Se connecter</span>
            </div>
            <div className='flex flex-col items-center ml-[50px]' >
                ...
                <span className=' text-label-lg font-semibold block mt-[3px] ' >Aide</span>
            </div>
            <div className='flex flex-col items-center ml-[50px]' >
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className=' text-label-lg font-semibold block mt-[3px] ' >Panier</span>
            </div>
        </div>
      </div>
      <div className=' h-[59px] px-20 flex items-center  bg-[#1E242F] ' >
        ...
        <nav>
            <ul className='inline ml-2 mr-[50px] ' >
                <li className='inline'>
                    <a className=' text-label-lg font-semibold text-white ' >Produits</a>
                </li> 
            </ul>
            <ul className='inline mr-[50px] ' >
                <li className='inline'>
                    <a className=' text-label-lg font-semibold text-white ' >Parrainage</a>
                </li> 
            </ul>
            <ul className='inline mr-[50px] ' >
                <li className='inline'>
                    <a className=' text-label-lg font-semibold text-white ' >Saint valentin</a>
                </li> 
            </ul>
            <ul className='inline mr-[50px] ' >
                <li className='inline'>
                    <a className=' text-label-lg font-semibold text-white ' >Nouveautés</a>
                </li> 
            </ul>
            <ul className='inline mr-[50px] ' >
                <li className='inline'>
                    <a className=' text-label-lg font-semibold text-white  ' >Categories</a>
