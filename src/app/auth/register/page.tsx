    ...
    <div className='bg-[#F3F3F3] w-full h-screen flex items-center justify-center'>
      ...
      <div className='w-full flex items-center justify-center ' >
        <div className=' bg-white rounded-[22px] py-[57px] px-[47px] w-[665px] ' >
            ...
            <span className=' block text-black text-para-md text-center w-full mt-4 mb-6'>
            ...
            <div className='mt-6 w-full flex flex-col gap-7' >
                <div className='h-[50px] w-full border border-[#727272] px-4 flex items-center ' >
                    <input type='text' className='outline-none h- w-full placeholder:text-[#727272] placeholder:font-semibold placeholder:text-label-lg bg-white text-[#727272] font-semibold text-label-lg' placeholder='Identifiant' />
                </div>
                <div className='h-[50px] w-full border border-[#727272] px-4 flex items-center' >
                    <input type='text' className='outline-none w-full placeholder:text-[#727272] placeholder:font-semibold placeholder:text-label-lg bg-white text-[#727272] font-semibold text-label-lg' placeholder='Numéro ou Email' />
                </div>
                <div className='h-[50px] w-full border border-[#727272] px-4 flex items-center' >
                    <input type='text' className='outline-none w-full placeholder:text-[#727272] placeholder:font-semibold placeholder:text-label-lg bg-white text-[#727272] font-semibold text-label-lg' placeholder='Mot de passe' />
                </div>
                <div className='h-[50px] w-full border border-[#727272] px-4 flex items-center' >
                    <input type='text' className='outline-none w-full placeholder:text-[#727272] placeholder:font-semibold placeholder:text-label-lg bg-white text-[#727272] font-semibold text-label-lg' placeholder='Confirmer le mot de passe' />
                </div>
                <Link href='/auth/2fauth' >
                ...
                <div className=' flex items-center justify-center ' >
                    <span className=' text-para-md text-[#727272] font-medium ' >Vous possédez déja un compte? <Link href='/auth/login' ><span className=' text-[#193364] font-semibold cursor-pointer ' >Identifiez-vous</span></Link></span>
                </div>
            </div>
